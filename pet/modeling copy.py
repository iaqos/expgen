...
def train_pet(ensemble_model_config: WrapperConfig, ensemble_train_config: TrainConfig,
    ...
    if ensemble_model_config.wrapper_type == GENERATIVE_WRAPPER:
        # Step 2: Merge the predictions of each individual model # AAA
        ...
        # Step 3: Train the final model on the merged predictions # AAA
...
CUSTOM_DATA = [InputExample(guid="test-0", \
                text_a="'A person on a horse jumps over a broken down airplane.' does not entail 'A person is training his horse for a competition.'", \
                label="the person is not necessarily training his horse"), \
                InputExample(guid="test-1", \
                text_a="'A person on a horse jumps over a broken down airplane.' does not entail 'A person is training his horse for a competition.'", \
                label="the person is not necessarily training his horse"), \
                InputExample(guid="test-2", \
                text_a="'A person on a horse jumps over a broken down airplane.' does not entail 'A person is training his horse for a competition.'", \
                label="the person is not necessarily training his horse")]
...
'''
{
  ...
  "logits": null,
  "meta": {},
  "output_text": "One cannot be on a jumping horse cannot be a diner ordering food.",
  "text_a": "'A person on a horse jumps over a broken down airplane.' contradicts 'A person is at a diner, ordering an omelette.'",
  "text_b": null
}
{
  "guid": "train-2",
  ...
  "logits": null,
  "meta": {},
  "output_text": "a broken down airplane is outdoors",
  "text_a": "'A person on a horse jumps over a broken down airplane.' entails 'A person is outdoors, on a horse.'",
  "text_b": null
}
{
  "guid": "train-3",
  ...
  "logits": null,
  "meta": {},
  "output_text": "Just because they are smiling and waving at a camera does not imply their parents or anyone is anyone behind it",
  "text_a": "'Children smiling and waving at camera' does not entail 'They are smiling at their parents'",
  "text_b": null
}]
'''
...
CUSTOM_PATH="/home/azaninello/pet-feature-genpet-new/output-bart-500-FINE-TUNING-?/final/p0-i0"
